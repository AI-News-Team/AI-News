...
from newsscrapper.spiders.cnn import CNNSpider
...
class CNNSpiderTest(unittest.TestCase):
    def setUp(self):
        self.spider = CNNSpider()
    ...
    def get_first_article_html(self):
        ...
        if main_page_response:
            ...
            first_article_url = main_page_response.xpath('//div[@class="stack_condensed__items "]/div/div/div/div/div//a/@href').get()
            ...
            for result in results:
                if result.url in expected_urls:
                    ...
                    if category_page_response.status_code == 200:
                        ...
                        articles = list(self.spider.parse(category_page_html))
